...
def hash_password(password, hash_salt):
  pass_hash = crypt.crypt(password, hash_salt)
  return pass_hash
...
password_hash = input("What is the hash? ")
...
# Set the file path
file_path = os.path.join(script_dir, "top10.txt")
with open(file_path, "r") as file:
  ...
  for guess in file:
    ...
    hashed_guess = hash_password(guess, password_salt)
    # Compare hashes
